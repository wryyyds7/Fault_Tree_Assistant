...
public interface VectorStoreService {
    ...
    List<ParagraphMetadata> createParagraphMetadata(String docId, List<Map<String, Object>> paragraphs);
    ...
    List<VectorStore> generateVectors(String docId, List<ParagraphMetadata> paragraphs);
